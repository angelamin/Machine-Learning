...
class MtcnnDetector(object):
    ...
    def detect_face(self, img):
        ...
        print("RNet reset Time used:",elapsed)

        start = time.clock()
        output = self.RNet.predict(input_buf)
        elapsed = (time.clock() - start)
        print("RNet model Time used:",elapsed)
        ...
        elapsed = (time.clock() - start)
        print("ONet reset Time used:",elapsed)

        start = time.clock()
        output = self.ONet.predict(input_buf)
        elapsed = (time.clock() - start)
        print("ONet model Time used:",elapsed)
        ...
        elapsed = (time.clock() - start)
        print("LNet reset Time used:",elapsed)

        start = time.clock()
        output = self.LNet.predict(input_buf)
        elapsed = (time.clock() - start)
        print("LNet model Time used:",elapsed)
