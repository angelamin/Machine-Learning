...
path = '/data1/shixi_xiamin/ctpn_side-refinement/data_ctpn/train_data/images'
gt_path = '/data1/shixi_xiamin/ctpn_side-refinement/data_ctpn/train_data/label'
out_path = 're_image'
