...
import sys
sys.path.append('..')
# from lib_crnn.local_utils import establish_char_dict
...
class FeatureIO(object):
    ...
    """
    def __init__(self, char_dict_path=ops.join(os.getcwd(), 'data_crnn/char_dict/char_dict.json'),
                 ord_map_dict_path=ops.join(os.getcwd(), 'data_crnn/char_dict/ord_map.json')):
