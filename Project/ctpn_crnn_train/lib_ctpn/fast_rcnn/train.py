...
class SolverWrapper(object):
    def __init__(self, sess, network, imdb, roidb, output_dir, logdir, pretrained_model):
...
#模型训练入口
def train_net(network, imdb, roidb, output_dir, log_dir, pretrained_model, max_iters=40000, restore=False):
