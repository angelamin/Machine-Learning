...
def process_db_parallel(base_dir, th=0.11):
    ...
    """
    db_path = osp.join(base_dir,'ucm2.mat')
    out_path = osp.join(base_dir,'seg_uint16_2.h5')
    # output h5 file:
...
base_dir = '/Users/xiamin/Desktop/SynthText_Chinese_version-master/chinese_sytnthtext_pre_data' # directory containing the ucm.mat, i.e., output of run_ucm.m
